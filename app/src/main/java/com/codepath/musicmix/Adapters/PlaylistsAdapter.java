...
public class PlaylistsAdapter extends RecyclerView.Adapter<PlaylistsAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Playlist playlist) {
            ...
            /*
            //getPlaylistImage(playlist.getId());
            ...
            query.getInBackground(playlist.getObjectId(), (object, e) -> {
                if (e == null) {
                    ...
                    object.put("image", new ParseFile("resume.txt", "My string content".getBytes()));
                    object.put("image", new ParseFile())
        ...
        /*
        public void getPlaylistImage(String playlistId) {
            String endpoint = "https://api.spotify.com/v1/playlists/" + playlistId + "/images";
